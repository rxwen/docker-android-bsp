...
RUN dpkg --add-architecture i386 && apt-get update && apt-get install -y curl bison g++-multilib git gperf libxml2-utils make zlib1g-dev zip zlib1g zlib1g-dev:i386 zlib1g:i386 libxml2-utils u-boot-tools python
