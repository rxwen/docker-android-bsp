...
RUN apt-get update && apt-get install -y curl bison g++-multilib git gperf libxml2-utils make zlib1g-dev zip zlib1g libxml2-utils u-boot-tools python flex mtd-utils expect
